    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '6px' }}>
        {['QB', 'RB', 'WR', 'TE'].map(pos => {
          ...
          return (
            <div key={pos} style={{ display: 'flex', width: '120px', alignItems: 'center', gap: '8px', padding: '4px 10px', borderRadius: '8px', background: 'var(--page-bg)', border: '1px solid var(--card-border)' }}>
