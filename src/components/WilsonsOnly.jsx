      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '3rem' }}>
        <div className='card' style={{ maxWidth: '480px', width: '100%', padding: '2.5rem', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Power Rankings, Trade History, League History, and Blueprint are generated by a
            weekly pipeline specific to this league and are not available for external leagues.
          </p>
          <button
